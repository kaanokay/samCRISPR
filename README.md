...
-  To seek CRISPR events a bit more far from cut site, user can extend sgRNA coordinates in bed file up to 5-10 bps more (this needs to be sure, check it out later on).
